...
@Entity
@Table(name="meals", uniqueConstraints = {@UniqueConstraint(columnNames = {"user_id","date_time"},name = "user_id_date_time_unq_idx")})
public class Meal extends AbstractBaseEntity {

    public static final String DELETE = "Meal.delete";
    public static final String GET = "Meal.get";
    public static final String GET_ALL = "Meal.get_all";
    public static final String GET_BETWEEN_HALF_OPEN = "Meal.get_all_between_half_open";
